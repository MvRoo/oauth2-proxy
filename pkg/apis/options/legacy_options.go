...
type LegacyProvider struct {
	...
	AzureSkipQueryGraphApi                 bool     `flag:"azure-skip-query-graph-api" cfg:"azure_skip_query_graph_api"`
...
func legacyProviderFlagSet() *pflag.FlagSet {
	...
	flagSet.Bool("azure-skip-query-graph-api", false, "skip retrieval of groups from the Graph API")
...
func (l *LegacyProvider) convert() (Providers, error) {
	...
	provider.AzureConfig = AzureOptions{
		...
		SkipQueryGraphApi:  l.AzureSkipQueryGraphApi,
	}
